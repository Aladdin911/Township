...
//    }
 ...
 level_up.setVisible(false);
    ...
    private void initComponents() {
        ...
        build_sweet.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/company/assets/sweet.png"))); // NOI18N
        ...
        build_sweet.setBounds(510, 620, 150, 120);
...
// TODO add your handling code here:
    ...
    private void optionsMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_optionsMouseEntered
        if (!barn.isShowing() && !back_ground.isShowing() && !option_manu.isShowing()) {
    ...
    private void soil_houseMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_soil_houseMousePressed
        ...
        if (!back_button.isShowing() && !option_manu.isShowing() && !duration.isShowing()) {

            music("b");        // TODO add your handling code here:
        }
        ...
        x = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (Player_1.getLevel() > y) {
                    ...
                    coin_rew.setText("" + (100 * Player_1.getLevel()));
...
// TODO add your handling code here:
    ...
    private void pay_by_cashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pay_by_cashActionPerformed
        setLabel_1(2);
        setLabel_2(2);// TODO add your handling code here:*/
